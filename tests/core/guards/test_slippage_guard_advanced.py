...
class TestSlippageGuardAdvanced:
    ...
    def test_multiple_instruments(self) -> None:
        ...
        for instrument in instruments:
            ...
            assert len(self.guard.slippage_history[instrument]) <= self.guard.window_size  # nosec: B101 # pytest assertion
    ...
    def test_check_slippage_threshold_calculation(self) -> None:
        ...
        assert self.guard.check_slippage("EURUSD", 1.1000, 1.1006) is True  # nosec: B101 # pytest assertion
        
        assert self.guard.check_slippage("EURUSD", 1.1000, 1.1007) is True  # nosec: B101 # pytest assertion
        
        assert self.guard.check_slippage("EURUSD", 1.1000, 1.1008) is False  # nosec: B101 # pytest assertion
    ...
    def test_check_slippage_with_empty_history_fallback(self) -> None:
        ...
        assert self.guard.check_slippage("NEWPAIR", 1.1000, 1.1006) is True  # nosec: B101 # pytest assertion
        
        assert self.guard.check_slippage("NEWPAIR", 1.1000, 1.1007) is True  # nosec: B101 # pytest assertion
        
        assert self.guard.check_slippage("NEWPAIR", 1.1000, 1.1008) is False  # nosec: B101 # pytest assertion
