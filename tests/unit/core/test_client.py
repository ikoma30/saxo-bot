...
class TestSaxoClient:
    ...
    def test_get_account_info_success(self, mock_get: MagicMock) -> None:
        ...
        assert (
            args[0] == "https://gateway.saxobank.com/openapi/port/v1/accounts/test_account_key"
        )  # nosec: B101 # pytest assertion
        assert (
    ...
    def test_get_positions_success(self, mock_get: MagicMock) -> None:
        ...
        assert (
            args[0]
            == "https://gateway.saxobank.com/openapi/port/v1/positions?FieldGroups=DisplayAndFormat"
        )  # nosec: B101 # pytest assertion
        assert (
            kwargs["headers"]["Authorization"] == "Bearer test_token"
        )  # nosec: B101 # pytest assertion
